# -*- coding: utf-8 -*-
"""
Created on Sun Oct 15 22:57:33 2017
...
with open('C:/Users/Mayur/Documents/Advance Data Science/Python Code/NYTimesData/Apple_StockPrice_Data_2007_2017/HistoricalPrices.csv', 'rt') as csvfile:
...
df1 = df
idx = pd.date_range('01-01-2007', '10-15-2017')
...
for year in years:
    for month in months:
        file_str = 'C:/Users/Mayur/Documents/Advance Data Science/Python Code/NYTimesData/Apple_json_files/' + str(year) + '-' + '{:02}'.format(month) + '.json'
        if os.path.isfile(file_str):
            with open(file_str) as data_file:
                NYTimes_data = json.load(data_file)
                NYTimes_data = json.loads(NYTimes_data)
                    ...
                    try:
                        if any(substring in NYTimes_data["response"]["docs"][:][i]['news_desk'].lower() for substring in news_desk_list):
                                ...
                                if date == current_date:
                                    ...
                                    interpolated_df.set_value(current_date, 'articles', current_article_str)
                                    current_date = date
                                    #interpolated_df.set_value(date, 'articles', current_article_str)
                                    #print str(date) + current_article_str
                                    current_article_str = articles_dict['headline']
...
interpolated_df.to_pickle('C:/Users/Mayur/Documents/Advance Data Science/Python Code/NYTimesData/Data/Datapickled_ten_year_filtered_lead_para1.pkl')  


# Save pandas frame in csv form
interpolated_df.to_csv('C:/Users/Mayur/Documents/Advance Data Science/Python Code/NYTimesData/Data/sample_interpolated_df_10_years_filtered_lead_para1.csv',
                       sep='\t', encoding='utf-8')



# Reading the data as pickle file
#dataframe_read = pd.read_pickle('C:/Users/Mayur/Documents/Advance Data Science/Python Code/NYTimesData/Data/pickled_ten_year_filtered_lead_para.pkl')
